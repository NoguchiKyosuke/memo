...
<head>
    ...
    <title>WebShogi (Standard) - ブラウザ将棋</title>
    ...
    <div id="game-container">
        ...
        <div id="sidebar">
            ...
            <div id="cpu-menu" style="display: none;">
                <h3>CPUレベル選択</h3>
                <button class="btn" onclick="game.startCPU('weak')">弱い (Weak)</button>
                <button class="btn" onclick="game.startCPU('normal')">普通 (Normal)</button>
                <button class="btn strong" onclick="game.startCPU('strong')">強い (Strong)</button>
                <button class="btn danger" onclick="game.startCPU('god')">神 (God)</button>
                <button class="btn secondary sm" onclick="game.showMainMenu()">戻る</button>
            </div>
