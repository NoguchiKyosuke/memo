...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM shogi_ranking WHERE google_user_id = :gid");
    ...
    if ($user) {
        ...
        if (isset($input['username'])) {
            ...
            try {
                $ins = $pdo->prepare("INSERT INTO shogi_ranking (username, google_user_id, rate) VALUES (:name, :gid, 1500)");
